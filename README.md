...
~~~sh
# getting the code
git clone git@github.com:nko4/team-us.git && cd ./team-us/

# developing
npm install
npm start

# deploying (to http://team-us.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@team-us.2013.nodeknockout.com
ssh root@team-us.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@team-us.2013.nodeknockout.com
ssh -i ./id_deploy root@team-us.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/team-us" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
